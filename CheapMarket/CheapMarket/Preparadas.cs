...
namespace Diseño
{
    public partial class Preparadas : Form
    {
        ...
        private void CargarProductos()
        {
            ...
            {
                dgvPreparadas.DataSource = Productos.CargarProductos2(ConexionBD.Conexion, consulta);
        ...
        private void pcbLupa_Click(object sender, EventArgs e)
        {
            if (ConexionBD.AbrirConexion())
            {
                dgvPreparadas.DataSource = Productos.FiltrarProductos(ConexionBD.Conexion, "COMIDAS PREPARADAS", txtBuscar.Text);
