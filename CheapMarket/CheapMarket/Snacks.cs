...
namespace Diseño
{
    public partial class Snacks : Form
    {
        ...
        private void CargarProductos()
        {
            ...
            {
                dgvSnacks.DataSource = Productos.CargarProductos2(ConexionBD.Conexion, consulta);
        ...
        //Metodo para ver agregar el producto al carrito
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (ConexionBD.AbrirConexion())
                {
                    if (Utilidades.ComprobarProducto(ConexionBD.Conexion, dgvSnacks.CurrentRow.Cells[0].Value.ToString()))
                    {
                        ConexionBD.CerrarConexion();
        ...
        private void pcbLupa_Click(object sender, EventArgs e)
        {
            if (ConexionBD.AbrirConexion())
            {
                dgvSnacks.DataSource = Productos.FiltrarProductos(ConexionBD.Conexion, "SNACKS", txtBuscar.Text);
