...
namespace Diseño
{
    public partial class Bebidas : Form
    {
        ...
        private void CargarProductos()
        {
            ...
            {
                dgvBebidas.DataSource = Productos.CargarProductos2(ConexionBD.Conexion, consulta);
        ...
        private void pcbLupa_Click(object sender, EventArgs e)
        {
            if (ConexionBD.AbrirConexion())
            {
                dgvBebidas.DataSource = Productos.FiltrarProductos(ConexionBD.Conexion, "BEBIDAS", txtBuscar.Text);
