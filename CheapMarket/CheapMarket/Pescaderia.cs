...
namespace Diseño
{
    public partial class Pescaderia : Form
    {
        ...
        private void CargarProductos()
        {
            ...
            {
                dgvPescaderia.DataSource = Productos.CargarProductos2(ConexionBD.Conexion, consulta);
        ...
        private void pcbLupa_Click(object sender, EventArgs e)
        {
            if (ConexionBD.AbrirConexion())
            {
                dgvPescaderia.DataSource = Productos.FiltrarProductos(ConexionBD.Conexion, "PESCADERIA", txtBuscar.Text);
        ...
        private void Pescaderia_Load(object sender, EventArgs e)
        {
