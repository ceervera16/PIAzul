...
namespace Diseño
{
    public partial class Verduleria : Form
    {
        public Verduleria()
        {
            InitializeComponent();
        ...
        private void CargarProductos()
        {
            ...
            string consulta = String.Format("SELECT Nombre, Precio, Descripcion FROM producto where Categoria='VERDULERIA'");
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (ConexionBD.AbrirConexion())
                {
                    if (Utilidades.ComprobarProducto(ConexionBD.Conexion, dgvVerduleria.CurrentRow.Cells[0].Value.ToString()))
                    {
                        ConexionBD.CerrarConexion();

                        string dni = Sesion.NifUsu;
                        string nombre = dgvVerduleria.CurrentRow.Cells[0].Value.ToString();
                        double precio = double.Parse(dgvVerduleria.CurrentRow.Cells[1].Value.ToString());
        ...
        private void Verduleria_Load(object sender, EventArgs e)
        {
