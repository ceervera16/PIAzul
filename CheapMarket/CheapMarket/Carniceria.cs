...
namespace Diseño
{
    public partial class Carniceria : Form
    {
        ...
        private void CargarProductos()
        {
            ...
            {
                dgvCarniceria.DataSource = Productos.CargarProductos2(ConexionBD.Conexion, consulta);
        ...
        //Metodo para ver info e imagen del producto
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (ConexionBD.AbrirConexion())
                {
                    if (Utilidades.ComprobarProducto(ConexionBD.Conexion, dgvCarniceria.CurrentRow.Cells[0].Value.ToString()))
                    {
                        ConexionBD.CerrarConexion();

                        string dni = Sesion.NifUsu;
                        string nombre = dgvCarniceria.CurrentRow.Cells[0].Value.ToString();
                        double precio = double.Parse(dgvCarniceria.CurrentRow.Cells[1].Value.ToString());
        ...
        private void pcbLupa_Click(object sender, EventArgs e)
        {
            if (ConexionBD.AbrirConexion())
            {          
                dgvCarniceria.DataSource = Productos.FiltrarProductos(ConexionBD.Conexion, "CARNICERIA", txtBuscar.Text);
        ...
        private void Carniceria_Load(object sender, EventArgs e)
        {
