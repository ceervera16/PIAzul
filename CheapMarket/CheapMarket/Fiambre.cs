...
namespace Diseño
{
    public partial class Fiambre : Form
    {
        public Fiambre()
        {
            InitializeComponent();
        ...
        private void CargarProductos()
        {
            ...
            {
                dgvFiambre.DataSource = Productos.CargarProductos2(ConexionBD.Conexion, consulta);
        ...
        private void dgvFiambre_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            string producto = dgvFiambre.CurrentRow.Cells[0].Value.ToString();
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (ConexionBD.AbrirConexion())
                {
                    if (Utilidades.ComprobarProducto(ConexionBD.Conexion, dgvFiambre.CurrentRow.Cells[0].Value.ToString()))
                    {
                        ConexionBD.CerrarConexion();

                        string dni = Sesion.NifUsu;
                        string nombre = dgvFiambre.CurrentRow.Cells[0].Value.ToString();
                        double precio = double.Parse(dgvFiambre.CurrentRow.Cells[1].Value.ToString());
        ...
        private void pcbLupa_Click(object sender, EventArgs e)
        {
            if (ConexionBD.AbrirConexion())
            {
                dgvFiambre.DataSource = Productos.FiltrarProductos(ConexionBD.Conexion, "FIAMBRES", txtBuscar.Text);
        ...
        private void Fiambre_Load(object sender, EventArgs e)
        {
